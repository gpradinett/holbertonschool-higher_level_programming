...
```
gpradinett@ubuntu:~/py/0x00$ cat main.py 
#!/usr/bin/python3
print("Best School")

gpradinett@ubuntu:~/py/0x00$ export PYFILE=main.py
gpradinett@ubuntu:~/py/0x00$ ./0-run
Best School
...
```
gpradinett@ubuntu:~/py/0x00$ export PYCODE='print(f"Best School: {88+10}")'
gpradinett@ubuntu:~/py/0x00$ ./1-run_inline 
Best School: 98
gpradinett@ubuntu:~/py/0x00$ 
```
<h2 align="center"> ------ </h2>
...
```
gpradinett@ubuntu:~/py/0x00$ ./2-print.py 
...
```
gpradinett@ubuntu:~/py/0x00$ ./3-print_number.py
98 Battery street
gpradinett@ubuntu:~/py/0x00$ 
```
<h2 align="center"> ------ </h2>
...
- You can find the source code [here](https://github.com/gpradinett/holbertonschool-higher_level_programming/blob/main/0x00-python-hello_world/4-print_float.py)
...
```
gpradinett@ubuntu:~/py/0x00$ ./4-print_float.py
Float: 3.14
gpradinett@ubuntu:~/py/0x00$ 
```
<h2 align="center"> ------ </h2>
...
```
gpradinett@ubuntu:~/py/0x00$ ./5-print_string.py 
...
```
gpradinett@ubuntu:~/py/0x00$ ./6-concat.py
Welcome to Holberton School!
gpradinett@ubuntu:~/py/0x00$ wc -l 6-concat.py
5 6-concat.py
gpradinett@ubuntu:~/py/0x00$ 
```
...
```
gpradinett@ubuntu:~/py/0x00$ ./7-edges.py
First 3 letters: Hol
Last 2 letters: on
Middle word: olberto
gpradinett@ubuntu:~/py/0x00$ wc -l 7-edges.py
8 7-edges.py
gpradinett@ubuntu:~/py/0x00$
```
...
```
gpradinett@ubuntu:~/py/0x00$ ./8-concat_edges.py
object-oriented programming with Python
gpradinett@ubuntu:~/py/0x00$ wc -l 8-concat_edges.py
5 8-concat_edges.py
gpradinett@ubuntu:~/py/0x00$
```
...
```
gpradinett@ubuntu:~/py/0x00$ ./9-easter_egg.py
The Zen of Python, by Tim Peters
...
```
gpradinett@ubuntu:~/0x00$ cat lists.h
#ifndef LISTS_H
#define LISTS_H
...
```
gpradinett@ubuntu:~/0x00$ cat 10-linked_lists.c
#include <stdio.h>
#include <stdlib.h>
#include "lists.h"
...
```
gpradinett@ubuntu:~/0x00$ cat 10-main.c
#include <stdlib.h>
#include <string.h>
#include <stdio.h>
#include "lists.h"
...
```
gpradinett@ubuntu:~/0x00$ gcc -Wall -Werror -Wextra -pedantic -std=gnu89 10-main.c 10-check_cycle.c 10-linked_lists.c -o cycle
...
```
gpradinett@ubuntu:~/py/0x00$ ./100-write.py
and that piece of art is useful - Dora Korpar, 2015-10-19
gpradinett@ubuntu:~/py/0x00$ echo $?
1
gpradinett@ubuntu:~/py/0x00$ ./100-write.py 2> q
gpradinett@ubuntu:~/py/0x00$ cat q
and that piece of art is useful - Dora Korpar, 2015-10-19
gpradinett@ubuntu:~/py/0x00$
```
<h2 align="center"> ------ </h2>
...
gpradinett@ubuntu:~/py/0x00$ export PYFILE=main.py
gpradinett@ubuntu:~/py/0x00$ ./101-compile
Compiling main.py ...
gpradinett@ubuntu:~/py/0x00$ ls
101-compile  main.py  main.pyc
gpradinett@ubuntu:~/py/0x00$ cat main.pyc | zgrep -c "Best School"
1
gpradinett@ubuntu:~/py/0x00$ od -t x1 main.pyc # SYSTEM DEPENDANT => CAN BE DIFFERENT
